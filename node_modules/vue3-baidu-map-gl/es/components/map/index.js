import { defineComponent, ref, getCurrentInstance, onMounted, onUnmounted, provide, openBlock, createElementBlock, Fragment, createElementVNode, normalizeStyle, unref, renderSlot, toDisplayString, nextTick, watch } from 'vue';
...
import { isString, error, callWhenDifferentValue } from '../../utils';

const _hoisted_1 = { style: { "color": "#999", "position": "absolute", "top": "50%", "left": "50%", "transform": "translate(-50%, -50%)" } };
const __default__ = {
    name: 'BMap'
};
var script = /*#__PURE__*/ defineComponent(Object.assign(Object.assign({}, __default__), { props: {
        ...
        center: { type: [String, Object], required: false, default: () => ({ lat: 39.915185, lng: 116.403901 }) },
            ...
            return (openBlock(), createElementBlock(Fragment, null, [
                createElementVNode("div", {
                    ...
                    renderSlot(_ctx.$slots, "loading", {
                        ...
                        createElementVNode("div", _hoisted_1, toDisplayString(!unref(initd) ? 'map loading...' : ''), 1 /* TEXT */)
                    ])
                ], 4 /* STYLE */),
