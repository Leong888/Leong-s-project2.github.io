...
declare const vue3BaiduMapGl: {
    install: (app: App, options?: InitOptions) => void;
    version: string;
};
export declare const install: (app: App, options?: InitOptions) => void;
export declare const version: string;
export { Map, Control, Scale, Zoom, Navigation3d, Marker, Marker3d, Copyright, Location, Label, Polyline, Polygon, BezierCurve, Circle, CityList, Prism, InfoWindow, ContextMenu, PanoramaControl, PanoramaCoverageLayer, GroundOverlay };
