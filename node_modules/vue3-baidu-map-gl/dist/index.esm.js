import { ref, onUnmounted, watch, getCurrentInstance, defineComponent, onMounted, provide, openBlock, createElementBlock, Fragment, createElementVNode, normalizeStyle, unref, renderSlot, toDisplayString, nextTick, inject, useAttrs, mergeProps, onUpdated, computed } from 'vue';
            ...
            return (openBlock(), createElementBlock(Fragment, null, [
                createElementVNode("div", {
                    ...
                    renderSlot(_ctx.$slots, "loading", {
                        isLoading: !unref(initd)
                    }, () => [
                        createElementVNode("div", _hoisted_1$1, toDisplayString(!unref(initd) ? 'map loading...' : ''), 1)
                    ])
                ], 4),
...
var script$c = /*#__PURE__*/ defineComponent(Object.assign(Object.assign({}, __default__$c), { props: {
...
var script$b = /*#__PURE__*/ defineComponent(Object.assign(Object.assign({}, __default__$b), { emits: ['initd', 'unload'], setup(__props) {
        const { ready } = useLifeCycle();
...
export { script$6 as BezierCurve, script$3 as Circle, script$g as CityList, script as ContextMenu, script$j as Control, script$e as Copyright, script$1 as GroundOverlay, script$4 as InfoWindow, script$8 as Label, script$f as Location, script$k as Map, script$a as Marker, script$9 as Marker3d, script$d as Navigation3d, script$c as PanoramaControl, script$b as PanoramaCoverageLayer, script$5 as Polygon, script$7 as Polyline, script$2 as Prism, script$i as Scale, script$h as Zoom, vue3BaiduMapGl as default, install, useAddressGeocoder, useAreaBoundary, useBrowserLocation, useIpLocation, usePoint, usePointGeocoder, useTrackAnimation, useViewAnimation, version };
