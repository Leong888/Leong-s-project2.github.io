(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Vue3baiduMapGl = {}, global.Vue));
  ...
  function useTrackAnimation(map, options) {
      ...
      let mapInstance;
      const status = vue.ref('INITIAL');
      vue.watch(() => map.value, (n) => {
  ...
  function useLifeCycle() {
      const { uid, emit: VueEmit } = vue.getCurrentInstance();
  ...
  const pluginLoaderMap = {
      ...
      MapvglThree: (customSourceLink) => getScriptAsync({
  ...
  const _hoisted_1$1 = { style: { "color": "#999", "position": "absolute", "top": "50%", "left": "50%", "transform": "translate(-50%, -50%)" } };
  const __default__$k = {
      name: 'BMap'
  };
  var script$k = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$k), { props: {
          ak: null,
          width: { default: '100%' },
          ...
          const props = __props;
          const mapContainer = vue.ref();
          let map = null;
          // 是否初始化
          let initd = vue.ref(false);
          // 地图初始化的发布
          const { ready } = useLifeCycle();
          const { uid, proxy } = vue.getCurrentInstance();
          ...
          function startWatchProps() {
              vue.watch(() => props.zoom, setZoom);
              vue.watch(() => props.tilt, setTilt);
              vue.watch(() => props.heading, setHeading);
              vue.watch(() => props.center, callWhenDifferentValue(setCenterAndZoom), {
                  deep: true
              });
              vue.watch(() => props.mapStyleId, initCustomStyle);
              vue.watch(() => props.mapStyleJson, callWhenDifferentValue(initCustomStyle), {
                  deep: true
              });
              vue.watch(() => props.displayOptions, callWhenDifferentValue(setDisplayOptions), {
                  deep: true
              });
              vue.watch(() => props.mapType, setMapType);
              vue.watch(() => props.enableTraffic, setTraffic);
              vue.watch(() => props.enableDragging, setDragging);
              vue.watch(() => props.enableInertialDragging, setInertialDragging);
              vue.watch(() => props.enableScrollWheelZoom, setScrollWheelZoom);
              vue.watch(() => props.enableContinuousZoom, setContinuousZoom);
              vue.watch(() => props.enableResizeOnCenter, setResizeOnCenter);
              vue.watch(() => props.enableDoubleClickZoom, setDoubleClickZoom);
              vue.watch(() => props.enableKeyboard, setKeyboard);
              vue.watch(() => props.enablePinchToZoom, setPinchToZoom);
              vue.watch(() => props.enableAutoResize, setAutoResize);
          }
          // 设置地图属性
          ...
          vue.provide('getMapInstance', () => map);
          vue.provide('parentUidGetter', uid);
          vue.provide('baseMapSetCenterAndZoom', (_center) => setCenterAndZoom(_center));
          vue.provide('baseMapSetDragging', (enableDragging) => setDragging(enableDragging));
          vue.provide('getBaseMapOptions', () => props);
          return (_ctx, _cache) => {
              return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
                  vue.createElementVNode("div", {
                      ...
                      ref: mapContainer,
                      style: vue.normalizeStyle([{ width: vue.unref(width), height: vue.unref(height) }, { "background": "#f1f1f1", "position": "relative", "overflow": "hidden" }])
                  }, [
                      vue.renderSlot(_ctx.$slots, "loading", {
                          isLoading: !vue.unref(initd)
                      }, () => [
                          vue.createElementVNode("div", _hoisted_1$1, vue.toDisplayString(!vue.unref(initd) ? 'map loading...' : ''), 1)
                      ])
                  ], 4),
  ...
  function useBaseMapEffect(cal) {
      ...
      const getMapInstance = vue.inject('getMapInstance');
      const parentUidGetter = vue.inject('parentUidGetter');
      const uid = parentUidGetter || ((_a = vue.getCurrentInstance()) === null || _a === void 0 ? void 0 : _a.uid);
  ...
  var script$j = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$j), { props: {
          anchor: { default: 'BMAP_ANCHOR_TOP_LEFT' },
          offset: { default: () => ({ x: 83, y: 18 }) }
      }, emits: ['initd', 'unload'], setup(__props) {
          const props = __props;
          const controlContainer = vue.ref();
          const { ready } = useLifeCycle();
  ...
  var script$i = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$i), { props: {
  ...
  var script$h = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$h), { props: {
  ...
  var script$g = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$g), { props: {
          anchor: { default: 'BMAP_ANCHOR_TOP_LEFT' },
  ...
  var script$f = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$f), { props: {
          anchor: { default: 'BMAP_ANCHOR_BOTTOM_RIGHT' },
          offset: { default: () => ({ x: 18, y: 18 }) },
  ...
  var script$e = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$e), { props: {
          anchor: { default: 'BMAP_ANCHOR_BOTTOM_RIGHT' },
          offset: { default: () => ({ x: 83, y: 18 }) }
      }, emits: ['initd', 'unload'], setup(__props) {
          var _a;
          const props = __props;
          const { ready } = useLifeCycle();
          const copyrightContainer = vue.ref();
          let copyrightControl;
          const uid = (_a = vue.getCurrentInstance()) === null || _a === void 0 ? void 0 : _a.uid;
          vue.onMounted(() => {
  ...
  var script$d = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$d), { props: {
          anchor: { default: 'BMAP_ANCHOR_BOTTOM_RIGHT' },
          offset: { default: () => ({ x: 83, y: 18 }) }
      }, emits: ['initd', 'unload'], setup(__props) {
          const props = __props;
  ...
  var script$c = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$c), { props: {
  ...
  var script$b = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$b), { emits: ['initd', 'unload'], setup(__props) {
          const { ready } = useLifeCycle();
  ...
  let icons = null;
  function useMarkerDefaultIcons() {
      if (icons !== null)
          return icons;
  ...
  var script$a = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$a), { props: {
          position: null,
          offset: { default: () => ({
                  x: 0,
                  y: 0
          ...
          useBaseMapEffect((map) => {
              ...
              init();
              // 监听值变化
              vue.watch(() => props.position, callWhenDifferentValue((n) => {
                  marker ? setPosition(n) : init();
              }), { deep: true });
              vue.watch(() => props.icon, callWhenDifferentValue(setIcon), { deep: true });
              vue.watch(() => props.offset, callWhenDifferentValue(setOffset), { deep: true });
              vue.watch(() => props.enableDragging, setDragging);
              vue.watch(() => props.enableMassClear, setMassClear);
              vue.watch(() => props.rotation, setRotation);
              return cal;
          });
          vue.provide('getOverlayInstance', () => marker);
          // 获取图标配置
  ...
  var script$9 = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$9), { props: {
          position: null,
          height: null,
          size: { default: 50 },
          ...
          useBaseMapEffect((map) => {
              ...
              vue.watch(() => props.height, (n) => {
                  marker3d ? setHeight(n) : init();
              });
              vue.watch(() => props.enableMassClear, setMassClear);
              vue.watch(() => props.icon, callWhenDifferentValue(setIcon), { deep: true });
              vue.watch(() => props.enableMassClear, setMassClear);
              vue.watch(() => props.fillOpacity, setFillOpacity);
              vue.watch(() => props.fillColor, setFillColor);
              return cal;
          });
          vue.provide('getOverlayInstance', () => marker3d);
          // 获取图标配置
          function getIconConfig() {
              const { icon } = props;
              // @ts-ignore
  ...
  var script$8 = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$8), { props: {
          content: null,
          position: null,
          offset: { default: () => ({
                  x: 0,
          ...
          useBaseMapEffect((map) => {
              ...
              ready(map, label);
              // 监听值变化
              vue.watch(() => props.position, callWhenDifferentValue(setPosition), { deep: true });
              vue.watch(() => props.offset, callWhenDifferentValue(setOffset), { deep: true });
              vue.watch(() => props.style, callWhenDifferentValue(setStyle), { deep: true });
              vue.watch(() => props.content, setContent);
              vue.watch(() => props.enableMassClear, setMassClear);
              return cal;
          });
          vue.provide('getOverlayInstance', () => label);
  ...
  var script$7 = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$7), { props: {
          path: null,
          ...
          useBaseMapEffect((map) => {
              ...
              init();
              // 监听值变化
              vue.watch(() => props.path, callWhenDifferentValue((n) => {
          ...
          vue.provide('getOverlayInstance', () => polyline);
  ...
  var script$6 = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$6), { props: {
          path: null,
          controlPoints: null,
          strokeColor: { default: '#000' },
          strokeWeight: { default: 2 },
          ...
          useBaseMapEffect((map) => {
              ...
              vue.watch(() => props.controlPoints, callWhenDifferentValue((n) => {
          ...
          vue.provide('getOverlayInstance', () => bezierCurve);
          function pathPointsToMapPoints(pathPoints) {
              return pathPoints.map(({ lng, lat }) => new BMapGL.Point(lng, lat));
          }
          function setPath(path) {
  ...
  var script$5 = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$5), { props: {
          path: null,
          ...
          const props = __props;
          const { ready } = useLifeCycle();
          const injectBaseMapSetCenterAndZoom = vue.inject('baseMapSetCenterAndZoom');
          let polygon;
          useBaseMapEffect((map) => {
              const cal = () => {
              ...
              vue.watch(() => props.path, callWhenDifferentValue((path) => {
          ...
          vue.provide('getOverlayInstance', () => polygon);
  ...
  var script$4 = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$4), { props: {
          ...
          const props = __props;
          const infoWindowContainer = vue.ref();
          ...
          useBaseMapEffect((map) => {
              ...
              vue.watch(() => props.maxWidth, setMaxWidth);
              vue.watch(() => props.enableAutoPan, setAutoPan);
              vue.watch(() => props.enableCloseOnClick, setCloseOnClick);
              vue.watch(() => props.modelValue, callWhenDifferentValue(() => {
          ...
          vue.provide('getOverlayInstance', () => infoWindow);
          function open() {
  ...
  var script$3 = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$3), { props: {
          center: null,
          radius: null,
          strokeColor: { default: '#000' },
          strokeOpacity: { default: 1 },
          ...
          useBaseMapEffect((map) => {
              ...
              init();
              // 监听值变化
              vue.watch(() => props.center, callWhenDifferentValue(setCenter), { deep: true });
              vue.watch(() => props.radius, setRadius);
              vue.watch(() => props.strokeColor, setStrokeColor);
              vue.watch(() => props.strokeOpacity, setStrokeOpacity);
              vue.watch(() => props.fillColor, setFillColor);
              vue.watch(() => props.fillOpacity, setFillOpacity);
          ...
          vue.provide('getOverlayInstance', () => circle);
  ...
  var script$2 = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$2), { props: {
          path: null,
          altitude: null,
          isBoundary: { type: Boolean },
          ...
          useBaseMapEffect((map) => {
              ...
              const init = () => {
                  ...
                  syncMapCenter();
                  vue.watch(() => props.enableMassClear, setMassClear);
                  vue.watch(() => props.topFillColor, setTopFillColor);
                  vue.watch(() => props.topFillOpacity, setTopFillOpacity);
                  vue.watch(() => props.sideFillColor, setSideFillColor);
                  vue.watch(() => props.sideFillOpacity, setSideFillOpacity);
                  vue.watch(() => props.altitude, setAltitude);
              };
              init();
              // 监听值变化, 初始为空时不会初始化, 不为空值时初始化
              vue.watch(() => props.path, callWhenDifferentValue(() => {
                  prism
                      ? () => {
                          cal();
                          init();
          ...
          vue.provide('getOverlayInstance', () => prism);
          function syncMapCenter() {
              if (props.autoCenter) {
                  vue.nextTick(() => {
                      var _a;
  ...
  var script$1 = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$1), { props: {
          type: null,
          url: null,
          startPoint: null,
          endPoint: null,
          ...
          useBaseMapEffect((map) => {
              ...
              vue.watch(() => props, callWhenDifferentValue(init), { deep: true });
              return cal;
          });
  ...
  var script = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__), { props: {
          width: { default: 100 },
          menuItems: { default: () => [] },
          onOpen: null,
          onClose: null
  ...
  exports.BezierCurve = script$6;
  exports.Circle = script$3;
  exports.CityList = script$g;
  exports.ContextMenu = script;
  exports.Control = script$j;
  exports.Copyright = script$e;
  exports.GroundOverlay = script$1;
  exports.InfoWindow = script$4;
  exports.Label = script$8;
  exports.Location = script$f;
  exports.Map = script$k;
  exports.Marker = script$a;
  exports.Marker3d = script$9;
  exports.Navigation3d = script$d;
  exports.PanoramaControl = script$c;
  exports.PanoramaCoverageLayer = script$b;
  exports.Polygon = script$5;
  exports.Polyline = script$7;
  exports.Prism = script$2;
  exports.Scale = script$i;
  exports.Zoom = script$h;
  exports["default"] = vue3BaiduMapGl;
  exports.install = install;
  exports.useAddressGeocoder = useAddressGeocoder;
  exports.useAreaBoundary = useAreaBoundary;
  exports.useBrowserLocation = useBrowserLocation;
  exports.useIpLocation = useIpLocation;
  exports.usePoint = usePoint;
  exports.usePointGeocoder = usePointGeocoder;
  exports.useTrackAnimation = useTrackAnimation;
